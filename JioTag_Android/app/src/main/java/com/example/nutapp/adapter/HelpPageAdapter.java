...
public class HelpPageAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View view = layoutInflater.inflate(R.layout.helpscreen_item_list, container, false);
        TextView mHeading = view.findViewById(R.id.screenTitle);
        ImageView mHelpImage = view.findViewById(R.id.helpscreenIcon);
        TextView mHelpContent = view.findViewById(R.id.helpcontent);
