...
public class ShareTagSuccessActivity extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_success_share_tag);
        Button shareSuccessfulBtn = findViewById(R.id.share_success_btn);
        shareSuccessfulBtn.setOnClickListener(this);
        setToolbarIconTitle();
    }
    ...
    public void onClick(View v) {
        Intent intent = new Intent(this,ShareViewTagActivity.class);
