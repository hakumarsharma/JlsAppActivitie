...
public class MQTTManager {
    ...
    public JiotMqttClient getMQTTClient(Context context) {
        if (jiotMqttClient == null) {
            ...
            JiotMqttCreateOptions jiotMqttCreateOptions = new JiotMqttCreateOptions(new DBManager(context).getAdminLoginDetail().getPhoneNumber(), Constant.MQTT_USER_NAME, Constant.MQTT_PASSWORD, Constant.MQTT_CIT_URL, jiotMqttSSLOptions);
