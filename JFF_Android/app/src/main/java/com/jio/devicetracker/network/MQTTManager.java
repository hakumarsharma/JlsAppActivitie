...
public class MQTTManager {
    ...
    public JiotMqttClient getMQTTClient(Context context) {
        if (jiotMqttClient == null) {
            ...
            JiotMqttCreateOptions jiotMqttCreateOptions = new JiotMqttCreateOptions(new DBManager(context).getAdminLoginDetail().getPhoneNumber(), Constant.DEV_USERNAME, Constant.DEV_PASSWORD, Constant.DEV_URL, jiotMqttSSLOptions);
