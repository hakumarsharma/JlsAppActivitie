...
for p in ` find . -type f \\( -name "*.py" -o -name "*.sh" -o -name "*.yaml" -o -name "*.yml" -o -name "*.java" -o -name "*.j2"  -o -name "*.MD"  -o -name "*.md"  -o -name "*.Md"  -o -name "*.c"  -o -name "*.h" -o -name "*.go" -o -name "*.swift" -o -name "*.m" \\) | cut -c3-  `
    do
