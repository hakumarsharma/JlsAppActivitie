...
import com.jio.database.pojo.response.TrackerdeviceResponse.Data;
...
public class TrackDeviceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class SuccessListener implements Response.Listener {
        ...
        public void onResponse(Object response) {
            ...
            List<Data> data= mtrackerresponse.getmData();
    ...
    private void gotoDashboard(List<Data> phoneList) {
